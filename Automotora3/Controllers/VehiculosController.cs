...
namespace Automotora3.Controllers
{
    public class VehiculosController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Modelo,Color,Precio,Año")] Vehiculos vehiculos)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Modelo,Color,Precio,Año")] Vehiculos vehiculos)
        {
            if (id != vehiculos.Id)
            {
                return NotFound();
